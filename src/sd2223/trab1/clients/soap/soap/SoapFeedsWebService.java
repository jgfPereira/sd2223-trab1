package sd2223.trab1.clients.soap.soap;

import jakarta.jws.WebService;
import sd2223.trab1.api.Message;
import sd2223.trab1.api.java.Feeds;
import sd2223.trab1.api.java.FeedsImpl;
...
public class SoapFeedsWebService extends SoapWebService<FeedsException> implements FeedsService {
    ...
    @Override
    public List<Message> getUserOnlyMessages(String user) throws FeedsException {
        return super.fromJavaResult(impl.getUserOnlyMessages(user));
    }
}
